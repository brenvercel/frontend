...
//     htmlOutput += `<div><p>
//     ${user.firstName} ${user.lastName} (${user.age}) from ${user.city} - Active? ${user.isActive}
//     </p></div>`;
// });
arrUsers.forEach(user => {
    // Check status of user and assign text to userStatus variable with CSS classes for styling
    userStatus = user.isActive ? "<span class='active-user'>ACTIVE</span>" : "<span class='inactive-user'>INACTIVInactive</span>";
    htmlOutput += `<div><p>
